 ...
 * Realiza a validação básica dos dados informados e
 * delega a autenticação ao controller.
 * @author luiza
 */
...
public class LoginCandidatoView extends javax.swing.JFrame {
    ...
    public LoginCandidatoView(UsuarioCandidatoController controller) {
    ...
    private void btnEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEntrarActionPerformed
        try {
            boolean sucesso = controller.login(
                txtEmail.getText(),
                txtSenha.getText()
            );
    ...
    private void btnCadastroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastroActionPerformed
        ...
        new CadastroCandidatoView().setVisible(true);
